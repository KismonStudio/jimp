...
The parser accepts the JSON null, boolean, number, string, array, and object grammar. JIMP scalar conversion is deliberately not implicit: JSON numbers remain exact validated number lexemes inside `JsonDocument`, avoiding I64 overflow and F64 precision loss.
